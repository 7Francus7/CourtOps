...
# Pattern to find the existing mapping
pattern = r'\{club\.priceRules\.map\(\(r: any\) => \([\s\S]*?\}\)\)\}'

# Ensure the pattern matches before replacing
if re.search(pattern, content):
    ...
    print("Could not find the priceRules map pattern")
