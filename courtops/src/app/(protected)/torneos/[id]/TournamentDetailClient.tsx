       ...
       return (
              <div className="p-6 max-w-7xl mx-auto space-y-6">
                     ...
                     <div className="flex flex-col gap-4">
                            <Link href="/torneos" className="text-muted-foreground hover:text-foreground flex items-center gap-2 text-sm font-medium transition-colors w-fit">
                                   <ArrowLeft size={16} />
                                   Volver a Torneos
                            </Link>
       ...
       return (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                     ...
                     <div className="col-span-full bg-card border border-border rounded-2xl p-6 shadow-sm">
                            <h3 className="text-lg font-bold text-foreground mb-4">Estado del Torneo</h3>
                            {tournament.categories.length === 0 ? (
                                   ...
                                   <div className="space-y-4">
                                          {tournament.categories.map((cat: any) => (
                                                 <div key={cat.id} className="flex items-center justify-between p-4 bg-muted/50 rounded-xl border border-border/50">
                                                        <div className="flex items-center gap-3">
                                                               <div className="w-10 h-10 rounded-lg bg-muted/50 flex items-center justify-center text-foreground/50 font-bold">
                                                                      {cat.name.substring(0, 2)}
                                                               </div>
                                                               <div>
                                                                      <h4 className="font-bold text-foreground">{cat.name}</h4>
                                                                      <p className="text-xs text-muted-foreground">{cat.teams.length} parejas • {cat.gender === 'MALE' ? 'Masculino' : cat.gender === 'FEMALE' ? 'Femenino' : 'Mixto'}</p>
                                                               </div>
                                                        </div>
       ...
       return (
              <div className="space-y-6">
                     <div className="flex justify-between items-center">
                            <h3 className="text-xl font-bold text-foreground">Categorías Habilitadas</h3>
                            <button
                                   onClick={onAdd}
                                   className="bg-primary hover:bg-primary/90 text-foreground text-sm font-bold py-2 px-4 rounded-xl flex items-center gap-2 shadow-lg shadow-primary/20 transition-all active:scale-95"
                            >
                                   <Plus size={16} />
                                   Nueva Categoría
                            </button>
                     ...
                     {tournament.categories.length === 0 ? (
                            <div className="text-center py-20 bg-muted/50 rounded-2xl border border-border/50 border-dashed">
                                   <Trophy className="mx-auto text-foreground/20 mb-4" size={48} />
                                   <p className="text-muted-foreground text-sm">No hay categorías creadas aún.</p>
                            </div>
                     ) : (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                   {tournament.categories.map((cat: any) => (
                                          <div key={cat.id} className="bg-card shadow-sm p-6 rounded-2xl border border-border flex justify-between items-start group">
                                                 <div>
                                                        <h4 className="text-xl font-bold text-foreground">{cat.name}</h4>
                                                        <div className="flex gap-2 mt-2">
                                                               <span className="text-[10px] font-bold bg-muted/30 px-2 py-1 rounded text-foreground/70">
                                                                      {cat.gender}
                                                               </span>
                                                 ...
                                                 <button
                                                        ...
                                                        className="text-muted-foreground hover:text-red-500 p-2 transition-colors opacity-0 group-hover:opacity-100"
                                                 >
                                                        <Trash2 size={18} />
                                                 </button>
                                          </div>
       ...
       if (tournament.categories.length === 0) {
              return (
                     <div className="text-center py-20">
                            <p className="text-muted-foreground">Primero debes crear una categoría para inscribir parejas.</p>
                     </div>
              )
       }
              ...
              <div className="space-y-6">
                     <div className="flex flex-col md:flex-row gap-4 justify-between items-start md:items-center bg-card shadow-sm p-4 rounded-xl border border-border">
                                   ...
                                   {tournament.categories.map((cat: any) => (
                                          <button
                                                 ...
                                                 className={`px-4 py-2 rounded-lg text-sm font-bold whitespace-nowrap transition-all ${activeCategoryId === cat.id
                                                        ...
                                                        : 'bg-muted/50 text-muted-foreground hover:text-foreground hover:bg-muted/30'
                                                        }`}
                                          >
                                                 {cat.name}
                                          </button>
                            ...
                            <button
                                   ...
                                   className="bg-primary hover:bg-primary/90 text-foreground text-sm font-bold py-2 px-4 rounded-xl flex items-center gap-2 shadow-lg shadow-primary/20 shrink-0"
                            >
                                   <Plus size={16} />
                                   Inscribir Pareja
                            </button>
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {!activeCategory || activeCategory.teams.length === 0 ? (
                                   <div className="col-span-full text-center py-10 bg-muted/50 rounded-2xl border border-border/50 border-dashed">
                                          <Users className="mx-auto text-foreground/20 mb-4" size={40} />
                                          <p className="text-muted-foreground text-sm">No hay parejas inscritas en {activeCategory?.name || 'esta categoría'}.</p>
                                   </div>
                            ) : (
                                   activeCategory.teams.map((team: any) => (
                                          <div key={team.id} className="bg-card shadow-sm p-5 rounded-xl border border-border group hover:border-primary/20 transition-colors">
                                                 <div className="flex justify-between items-start mb-3">
                                                        <div>
                                                               <span className="text-[10px] font-bold text-primary uppercase tracking-wider mb-1 block">Pareja Inscrita</span>
                                                               <h4 className="font-bold text-foreground text-lg leading-tight">{team.player1Name} <span className="text-foreground/30">&</span> {team.player2Name}</h4>
                                                        </div>
                                                        <button onClick={() => handleDeleteTeam(team.id)} className="text-foreground/20 hover:text-red-500 transition-colors">
                                                               <Trash2 size={16} />
                                                        </button>
                                                 </div>
                                                 <div className="space-y-2">
                                                        <div className="flex items-center gap-3 bg-muted/50 p-2 rounded-lg">
                                                               ...
                                                               <div>
                                                                      ...
                                                                      <p className="text-xs text-foreground/40">{team.player1Phone || 'Sin teléfono'}</p>
                                                               </div>
                                                        </div>
                                                        <div className="flex items-center gap-3 bg-muted/50 p-2 rounded-lg">
                                                               ...
                                                               <div>
                                                                      ...
                                                                      <p className="text-xs text-foreground/40">{team.player2Phone || 'Sin teléfono'}</p>
                                                               </div>
                                                        </div>
                                                 </div>
                                          </div>
                     ...
                     {tournament.categories.map((cat: any) => {
                            ...
                            return (
                                   <div key={cat.id} className="space-y-6 animate-in fade-in duration-300">
                                          ...
                                          {!hasFixture ? (
                                                 <div className="bg-card shadow-sm border border-border rounded-2xl p-8 flex flex-col items-center text-center">
                                                        <div className="w-16 h-16 rounded-full bg-muted/50 flex items-center justify-center mb-4">
                                                               <LayoutGrid className="text-foreground/20" size={32} />
                                                        </div>
                                                        <h4 className="text-lg font-bold text-foreground mb-2">Generar Fixture</h4>
                                                        ...
                                                        {teamCount < 2 ? (
                                                               ...
                                                               <div className="flex items-center gap-4 bg-muted/50 p-2 pr-2 rounded-xl border border-border/50">
                                                                      <div className="flex items-center gap-3 px-3">
                                                                             <span className="text-xs font-bold text-muted-foreground uppercase">Zonas:</span>
                                                                             <div className="flex items-center gap-2">
                                                                                    <button
                                                                                           onClick={() => setZonesInput({ ...zonesInput, [cat.id]: Math.max(1, (zonesInput[cat.id] || 1) - 1) })}
                                                                                           className="w-6 h-6 rounded bg-muted/30 hover:bg-muted/50 flex items-center justify-center text-foreground"
                                                                                    >-</button>
                                                                      ...
                                                                      <button
                                                                             ...
                                                                             className="bg-primary hover:bg-primary/90 text-foreground font-bold py-2 px-6 rounded-lg shadow-lg shadow-primary/20 transition-all active:scale-95 disabled:opacity-50"
                                                                      >
                                                                             ...
                                                                             <div key={group.id} className="space-y-4">
                                                                                    ...
                                                                                    <div className="bg-card rounded-xl border border-border overflow-hidden shadow-sm">
                                                                                           <table className="w-full text-sm">
                                                                                                  <thead className="bg-muted/50 text-xs text-muted-foreground font-bold uppercase">
                                                                                                         <tr>
                                                                                                  ...
                                                                                                  <tbody className="divide-y divide-border">
                                                                                                         {sortedTeams.map((team: any, i: number) => (
                                                                                                                <tr key={team.id}>
                                                                                                                       <td className="px-4 py-2 text-foreground font-medium flex items-center gap-2">
                                                                                                                              <span className={cn("text-xs w-4", i === 0 ? "text-yellow-500 font-bold" : "text-muted-foreground/60")}>{i + 1}</span>
                                                                                                                       ...
                                                                                                                       <td className="px-2 py-2 text-center text-muted-foreground">{team.matchesPlayed}</td>
                                                                                                                </tr>
                                                                                                         ))}
                                                                                                  </tbody>
                                                                                           </table>
...
function MatchCard({ match, onEdit }: { match: any, onEdit?: () => void }) {
       return (
              <div className="bg-card group hover:bg-muted/10 border border-border/50 hover:border-border rounded-xl p-0 overflow-hidden transition-all duration-300 shadow-sm relative flex">
                     <div className={cn("w-1.5 transition-colors", match.status === 'COMPLETED' ? "bg-green-500" : "bg-muted/50 group-hover:bg-primary")} />
                     <div className="flex-1 p-4">
                            <div className="flex justify-between items-center text-[10px] text-muted-foreground font-bold uppercase tracking-wider mb-3">
                                   ...
                                   <div className={`flex items-center gap-1.5 px-2 py-0.5 rounded-full ${match.status === 'COMPLETED' ? 'bg-green-500/10 text-green-500' : 'bg-muted/50 text-muted-foreground'}`}>
                            ...
                            <div className="space-y-3">
                                   ...
                                   <div className="flex justify-between items-center group/team">
                                          <div className="flex items-center gap-3">
                                                 ...
                                                 <p className={cn("font-bold text-sm transition-colors", match.winnerId === match.homeTeamId ? "text-green-400" : "text-foreground group-hover/team:text-blue-400")}>{match.homeTeam?.name || 'Pareja 1'}</p>
                                          </div>
                                          <span className={cn("text-lg font-bold", match.homeScore ? "text-foreground" : "text-muted-foreground/30")}>{match.homeScore || '0'}</span>
                                   </div>

                                   <div className="h-px bg-muted/50 w-full my-1" />
                                   ...
                                   <div className="flex justify-between items-center group/team">
                                          <div className="flex items-center gap-3">
                                                 ...
                                                 <p className={cn("font-bold text-sm transition-colors", match.winnerId === match.awayTeamId ? "text-green-400" : "text-foreground group-hover/team:text-pink-400")}>{match.awayTeam?.name || 'Pareja 2'}</p>
                                          </div>
                                          <span className={cn("text-lg font-bold", match.awayScore ? "text-foreground" : "text-muted-foreground/30")}>{match.awayScore || '0'}</span>
                                   </div>
                            </div>
                     </div>

                     {/* Action Button Area */}
                     <button onClick={onEdit} className="w-12 border-l border-border/50 flex items-center justify-center bg-foreground/[0.02] group-hover:bg-foreground/[0.04] cursor-pointer hover:bg-primary/10 transition-colors">
                            <Settings size={16} className="text-muted-foreground/60 group-hover:text-primary transition-colors" />
                     </button>
              </div>
       )
}
       ...
       return (
              <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
                     <div className="bg-card shadow-sm w-full max-w-md rounded-2xl border border-border p-6 shadow-2xl animate-in zoom-in-95 duration-200">
                            <h3 className="text-xl font-bold text-foreground mb-6">Cargar Resultado</h3>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                   {/* Winner Selection */}
                                   <div className="space-y-3">
                                          <label className="text-xs font-bold text-muted-foreground uppercase">¿Quién ganó?</label>
                                          <div className="grid grid-cols-2 gap-3">
                                                 <div
                                                        ...
                                                        className={cn(
                                                               ...
                                                               winner === match.homeTeamId ? "bg-primary/20 border-primary text-foreground" : "bg-muted/50 border-border/50 text-muted-foreground hover:bg-muted/30"
                                                        )}
                                                 >
                                                 ...
                                                 <div
                                                        ...
                                                        className={cn(
                                                               "p-4 rounded-xl border cursor-pointer transition-all flex flex-col items-center gap-2",
                                                               winner === match.awayTeamId ? "bg-primary/20 border-primary text-foreground" : "bg-muted/50 border-border/50 text-muted-foreground hover:bg-muted/30"
                                                        )}
                                                 >
                                   ...
                                   {/* Score Input */}
                                   <div>
                                          <label className="text-xs font-bold text-muted-foreground uppercase">Resultado (Sets)</label>
                                          <input
                                                 value={score}
                                                 onChange={e => setScore(e.target.value)}
                                                 placeholder="Ej: 6-3 6-4"
                                                 className="w-full bg-background border border-border rounded-lg p-4 text-foreground text-lg text-center mt-1 outline-none focus:border-primary placeholder:text-slate-600"
                                          />
                                          <p className="text-[10px] text-muted-foreground mt-2 text-center">Ingresa el marcador completo de los sets.</p>
                                   </div>

                                   <div className="flex gap-3 pt-4">
                                          <button type="button" onClick={onClose} className="flex-1 py-3 text-sm font-bold text-muted-foreground hover:text-foreground">Cancelar</button>
                                          <button disabled={loading || !winner} className="flex-[2] py-3 bg-primary text-foreground text-sm font-bold rounded-xl hover:bg-primary/90 disabled:opacity-50">
...
function CreateCategoryModal({ isOpen, onClose, tournamentId }: any) {
       ...
       return (
              <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
                     <div className="bg-card shadow-sm w-full max-w-md rounded-2xl border border-border p-6 shadow-2xl">
                            <h3 className="text-xl font-bold text-foreground mb-6">Nueva Categoría</h3>
                            <form onSubmit={handleSubmit} className="space-y-4">
                                   <div>
                                          ...
                                          <input
                                                 ...
                                                 className="w-full bg-background border border-border rounded-lg p-3 text-foreground mt-1 outline-none focus:border-primary"
                                                 required
                                          />
                                   </div>
                                   <div className="grid grid-cols-2 gap-4">
                                          <div>
                                                 <label className="text-xs font-bold text-muted-foreground uppercase">Precio Inscripción</label>
                                                 <input
                                                        type="number"
                                          ...
                                          <div>
                                                 <label className="text-xs font-bold text-muted-foreground uppercase">Género</label>
                                                 <select
                                   ...
                                   <div className="flex gap-3 mt-6 pt-4 border-t border-border/50">
                                          <button type="button" onClick={onClose} className="flex-1 py-3 text-sm font-bold text-muted-foreground hover:text-foreground">Cancelar</button>
                                          <button disabled={loading} className="flex-1 py-3 bg-primary text-foreground text-sm font-bold rounded-xl hover:bg-primary/90 disabled:opacity-50">
...
function CreateTeamModal({ isOpen, onClose, categoryId, categoryName }: any) {
       ...
       return (
              <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
                     <div className="bg-card shadow-sm w-full max-w-2xl rounded-2xl border border-border p-6 shadow-2xl max-h-[90vh] overflow-y-auto">
                            ...
                            {(showP1Create || showP2Create) ? (
                                   <div className="space-y-4 animate-in fade-in zoom-in duration-200">
                                          <div className="flex justify-between items-center mb-4">
                                                 <h3 className="text-xl font-bold text-foreground">Nuevo Jugador</h3>
                                                 <button onClick={() => { setShowP1Create(false); setShowP2Create(false); }} className="text-muted-foreground hover:text-foreground">Cancelar</button>
                                          </div>
                                          <div className="space-y-4">
                                                 <div>
                                                        <label className="text-xs font-bold text-muted-foreground uppercase">Nombre Completo</label>
                                                        <input value={newClientName} onChange={e => setNewClientName(e.target.value)} className="w-full bg-muted/50 border border-border p-3 rounded-xl text-foreground outline-none focus:border-primary" />
                                                 </div>
                                                 <div>
                                                        <label className="text-xs font-bold text-muted-foreground uppercase">Teléfono</label>
                                                        <input value={newClientPhone} onChange={e => setNewClientPhone(e.target.value)} className="w-full bg-muted/50 border border-border p-3 rounded-xl text-foreground outline-none focus:border-primary" />
                                                 </div>
                                                 <div>
                                                        <label className="text-xs font-bold text-muted-foreground uppercase">Categoría</label>
                                                        <input value={newClientCategory} onChange={e => setNewClientCategory(e.target.value)} className="w-full bg-muted/50 border border-border p-3 rounded-xl text-foreground outline-none focus:border-primary" placeholder="Ej. 7ma" />
                                                 </div>
                                                 <button onClick={handleCreateClient} className="w-full bg-primary text-foreground font-bold py-3 rounded-xl hover:bg-primary/90">Guardar Jugador</button>
                                          </div>
                                   </div>
                            ) : (
                                   <>
                                          <h3 className="text-xl font-bold text-foreground mb-6">Inscribir Pareja - Categoría {categoryName}</h3>
                                          <form onSubmit={handleSubmit} className="space-y-6">
                                                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                        ...
                                                        <div className="space-y-2">
                                                               ...
                                                               <div className="relative">
                                                                      <div className="absolute left-3 top-3 text-muted-foreground"><Search size={18} /></div>
                                                                      <input
                                                                             value={p1Search}
                                                                             onChange={e => { setP1Search(e.target.value); setSelectedP1(null); }}
                                                                             placeholder="Buscar J1..."
                                                                             className={`w-full bg-background border ${selectedP1 ? 'border-blue-500/50 text-blue-500 font-bold' : 'border-border text-foreground'} rounded-xl pl-10 pr-3 py-3 outline-none focus:border-blue-500`}
                                                                      />
                                                                      {/* Dropdown Results */}
                                                                      {p1Results.length > 0 && !selectedP1 && (
                                                                             <div className="absolute top-full left-0 right-0 mt-2 bg-card shadow-sm border border-border rounded-xl shadow-2xl z-20 overflow-hidden max-h-40 overflow-y-auto">
                                                                                    {p1Results.map(client => {
                                                                                           ...
                                                                                           return (
                                                                                                  <div
                                                                                                         ...
                                                                                                         className={cn(
                                                                                                                "p-3 border-b border-border/50 last:border-0 flex justify-between items-center transition-colors",
                                                                                                                validation.allowed ? "hover:bg-muted/50 cursor-pointer" : "opacity-40 cursor-not-allowed grayscale bg-red-500/5"
                                                                                                         )}
                                                                                                  >
                                                                                                         <div>
                                                                      ...
                                                                      {!selectedP1 && p1Search.length > 1 && p1Results.length === 0 && (
                                                                             <button type='button' onClick={() => openCreate('P1')} className="absolute right-2 top-2 p-1 bg-muted/30 hover:bg-white/20 rounded-lg text-xs font-bold text-foreground flex items-center gap-1 transition-colors">
                                                               ...
                                                               {selectedP1 && (
                                                                      <div className="bg-blue-500/10 p-3 rounded-lg border border-blue-500/20 text-xs">
                                                                             <div className="flex justify-between">
                                                                                    ...
                                                                                    <span className={`font-bold ${p1Invalid ? 'text-red-500' : 'text-foreground'}`}>{selectedP1.category || 'Sin Cat.'}</span>
                                                                             </div>
                                                        ...
                                                        <div className="space-y-2">
                                                               ...
                                                               <div className="relative">
                                                                      ...
                                                                      <input
                                                                             ...
                                                                             className={`w-full bg-background border ${selectedP2 ? 'border-purple-500/50 text-purple-500 font-bold' : 'border-border text-foreground'} rounded-xl pl-10 pr-3 py-3 outline-none focus:border-purple-500`}
                                                                      />
                                                                      ...
                                                                      {!selectedP2 && p2Search.length > 1 && p2Results.length === 0 && (
                                                                             <button type='button' onClick={() => openCreate('P2')} className="absolute right-2 top-2 p-1 bg-muted/30 hover:bg-white/20 rounded-lg text-xs font-bold text-foreground flex items-center gap-1 transition-colors">
                                                                                    <UserPlus size={14} /> Nuevo
                                                                             </button>
                                                                      )}
                                                               </div>
                                                               {selectedP2 && (
                                                                      <div className="bg-purple-500/10 p-3 rounded-lg border border-purple-500/20 text-xs">
                                                                             <div className="flex justify-between">
                                                                                    <span className="text-muted-foreground">Categoría:</span>
                                                                                    <span className={`font-bold ${p2Invalid ? 'text-red-500' : 'text-foreground'}`}>{selectedP2.category || 'Sin Cat.'}</span>
                                                                             </div>
                                                 ...
                                                 {selectedP1 && selectedP2 && (
                                                        <div className={cn(
                                                               ...
                                                               <span className="text-[10px] items-center flex gap-1 font-bold uppercase tracking-wider text-muted-foreground">
                                                                      Suma de Categorías
                                                               </span>
                                                               <div className="flex items-center gap-3">
                                                                      <span className="text-2xl font-black text-foreground">{currentSum}</span>
                                                                      {teamInvalid ? (
                                                 ...
                                                 <div className="flex gap-3 mt-6 pt-4 border-t border-border/50">
                                                        <button type="button" onClick={onClose} className="flex-1 py-3 text-sm font-bold text-muted-foreground hover:text-foreground">Cancelar</button>
                                                        <button disabled={loading || !selectedP1 || !selectedP2 || p1Invalid || p2Invalid || teamInvalid} className="flex-[2] py-3 bg-primary text-foreground text-sm font-bold rounded-xl hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed">
...
function TournamentSettingsModal({ isOpen, onClose, tournament, router }: any) {
       ...
       return (
              <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
                     <div className="bg-card shadow-sm w-full max-w-md rounded-2xl border border-border p-6 shadow-2xl animate-in zoom-in-95 duration-200">
                            <h3 className="text-xl font-bold text-foreground mb-6">Configuración del Torneo</h3>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                   <div className="space-y-4">
                                          <div>
                                                 <label className="text-xs font-bold text-muted-foreground uppercase block mb-2">Nombre del Torneo</label>
                                                 <input
                                                        value={name}
                                                        onChange={e => setName(e.target.value)}
                                                        className="w-full bg-background border border-border rounded-lg p-3 text-foreground text-sm outline-none focus:border-primary"
                                          ...
                                          <div className="grid grid-cols-2 gap-4">
                                                 <div>
                                                        <label className="text-xs font-bold text-muted-foreground uppercase block mb-2">Fecha Inicio</label>
                                                        <input
                                                               type="date"
                                                               value={startDate}
                                                 ...
                                                 <div>
                                                        <label className="text-xs font-bold text-muted-foreground uppercase block mb-2">Estado</label>
                                                        <select
                                                               value={status}
                                   ...
                                   <div className="flex gap-3 pt-4 border-t border-border/50">
                                          <button type="button" onClick={onClose} className="flex-1 py-3 text-sm font-bold text-muted-foreground hover:text-foreground">Cancelar</button>
                                          <button disabled={loading} className="flex-[2] py-3 bg-primary text-foreground text-sm font-bold rounded-xl hover:bg-primary/90 disabled:opacity-50">
