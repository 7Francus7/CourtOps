...
export default function BillingPage() {
       ...
       const plans = [
              {
                     ...
                     features: ['Hasta 2 Canchas', 'Turnero Digital Inteligente', 'Caja Básica', 'Setup incluido', 'Soporte por Email L-V'],
                     highlight: false,
                     color: 'blue'
              },
              {
              ...
              },
              {
                     ...
                     features: ['Canchas Ilimitadas', 'Gestión de Múltiples Sedes', 'Dominio Personalizado', 'Módulo de Torneos Pro', 'Roles y Permisos Granulares', 'Ejecutivo de Cuenta Dedicado'],
                     highlight: false,
                     color: 'purple'
              },
       ]
       ...
       return (
              <div className="min-h-full w-full bg-slate-50 dark:bg-zinc-950 text-slate-900 dark:text-zinc-100 p-4 sm:p-6 lg:p-12 relative overflow-hidden transition-colors duration-300">
                     ...
                     <div className="relative z-10 max-w-6xl mx-auto">
                            ...
                            <div className="text-center mb-16 space-y-4">
                                   ...
                                   <p className="text-slate-600 dark:text-zinc-400 max-w-2xl mx-auto text-lg">
                                          Elegí el plan que mejor se adapte a tus necesidades. Sin costos de instalación, sin setup fee. Solo una mensualidad con todo incluido.
                                   </p>

                                   {/* Billing Cycle Toggle */}
                                   <div className="flex items-center justify-center mt-8 gap-4 select-none">
                                          <span
                                          ...
                                          <button
                                                 ...
                                                 className="w-14 h-7 bg-slate-200 dark:bg-zinc-800 rounded-full relative p-1 transition-colors hover:bg-slate-300 dark:hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-emerald-500/20"
                                          >
                                                 <div className={cn("w-5 h-5 bg-white dark:bg-zinc-100 rounded-full shadow-lg transition-transform duration-300", billingCycle === 'yearly' ? "translate-x-7" : "translate-x-0")} />
                                          </button>
                                          <span
                                   ...
                                   {plans.map((plan) => {
                                          ...
                                          return (
                                                 ...
                                                 >
                                                        ...
                                                        <button
                                                               onClick={() => {
                                                                      window.open(`https://wa.me/5493524421497?text=Hola,%20me%20interesa%20el%20plan%20${plan.name}%20(${isYearly ? 'Anual' : 'Mensual'})%20de%20CourtOps`, '_blank')
                                                               }}
                                                               className={cn(
                            ...
                            {/* Enterprise Banner */}
                            <div className="mt-16 relative group cursor-pointer overflow-hidden rounded-3xl border border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 p-8 md:p-12 text-center transition-all hover:border-slate-300 dark:hover:border-zinc-700 shadow-sm hover:shadow-md">
                                   ...
                                   <div className="relative z-10 flex flex-col items-center gap-4">
                                          ...
                                          <button
                                                 ...
                                                 className="inline-flex items-center gap-2 text-slate-900 dark:text-white border-b border-purple-500 pb-1 hover:text-purple-600 dark:hover:text-purple-400 transition-colors font-bold uppercase tracking-wider text-sm"
                                          >
