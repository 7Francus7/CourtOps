...
const translations: Translations = {
       es: {
              ...
              'new_tournament_desc': 'Configura los datos básicos para comenzar.',
              'tournament_name': 'Nombre del Torneo',
              'tournament_name_placeholder': 'Ej. Torneo Apertura 2026',
              ...
              'error_creating_tournament': 'Error al crear torneo',
              'success_creating_tournament': 'Torneo creado exitosamente',

              // Tournament Details
              'public_link': 'Link Público',
              'public_link_copied': 'Link público copiado',
              'configure': 'Configurar',
              'overview': 'Resumen',
              'inscriptions': 'Inscripciones',
              'registered_pairs': 'Parejas Inscritas',
              'scheduled_matches': 'Partidos Programados',
              'tournament_status': 'Estado del Torneo',
              'no_categories': 'No hay categorías configuradas.',
              'go_to_categories': 'Ve a la pestaña "Categorías" para comenzar.',
              'male': 'Masculino',
              'female': 'Femenino',
              'mixed': 'Mixto',
              'enabled_categories': 'Categorías Habilitadas',
              'new_category': 'Nueva Categoría',
              'delete_category_confirm': '¿Estás seguro de eliminar esta categoría? Se borrarán todos los equipos asociados.',
              'category_deleted': 'Categoría eliminada',
              'error_deleting': 'Error al eliminar',
              'register_pair': 'Inscribir Pareja',
              'pair_registered': 'Pareja Inscrita',
              'delete_pair_confirm': '¿Eliminar esta pareja?',
              'pair_deleted': 'Pareja eliminada',
              'no_pairs_in_category': 'No hay parejas inscritas en esta categoría.',
              'generate_fixture': 'Generar Fixture',
              'generate_fixture_desc': 'Crea automáticamente las zonas y partidos para las parejas inscritas.',
              'insufficient_pairs': 'Insuficientes parejas (Mínimo 2)',
              'zones': 'Zonas',
              'generating': 'Generando...',
              'generate': 'Generar',
              'fixture_generated_success': 'Fixture generado exitosamente',
              'reset_fixture': 'Reiniciar Fixture',
              'reset_fixture_confirm': '¿Estás seguro de eliminar TODO el fixture de esta categoría? Se borrarán los partidos.',
              'fixture_active': 'Fixture Activo',
              'group_phase': 'Fase de Grupos',
              'load_result': 'Cargar Resultado',
              'who_won': '¿Quién ganó?',
              'result_sets': 'Resultado (Sets)',
              'result_hint': 'Ingresa el marcador completo de los sets (ej: 6-3 6-4).',
              'save_result': 'Guardar Resultado',
              'result_saved': 'Resultado guardado',
              'select_winner_error': 'Selecciona un ganador',
              'error_select_two_players': 'Debes seleccionar 2 jugadores',
              'level_not_allowed': 'Nivel no permitido',
              'pair_registered_success': 'Pareja inscrita correctamente',
              'error_registering': 'Error al inscribir',
              'player_created_success': 'Jugador creado correctamente',
              'error_creating_player': 'Error al crear jugador',
              'new_player': 'Nuevo Jugador',
              'full_name': 'Nombre Completo',
              'phone': 'Teléfono',
              'category_label': 'Categoría',
              'save_player': 'Guardar Jugador',
              'register_pair_title': 'Inscribir Pareja',
              'player_1': 'Jugador 1',
              'player_2': 'Jugador 2',
              'search_player': 'Buscar Jugador...',
              'create_new_short': 'Nuevo',
              'sum_categories': 'Suma de Categorías',
              'register_pair_action': 'Inscribir Pareja',
              'saving': 'Guardando...',
              'category_created': 'Categoría creada',
              'error_creating_category': 'Error al crear',
              ...
              'tournament_settings': 'Configuración del Torneo',
              'status_draft': 'Borrador',
              'status_active': 'En Curso',
              'save_changes': 'Guardar Cambios',
              'delete_tournament_title': 'Eliminar Torneo',
