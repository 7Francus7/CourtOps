       ...
       return (
              <div className="space-y-6">
                            ...
                            <div className="flex items-center gap-2 overflow-x-auto pb-2 sm:pb-0 scrollbar-hide">
                                   <button
                                          ...
                                          className={cn(
                                                 ...
                                                 !selectedPlayer ? "bg-primary text-slate-900 border-primary shadow-lg" : "bg-white dark:bg-zinc-900 text-slate-400 dark:text-zinc-500 border-slate-200 dark:border-white/5 hover:border-slate-300 dark:hover:border-white/10"
                                          )}
                                   >
                                          General
                                   </button>
                                   {players.map(player => (
                                          <button
                                                 ...
                                                 className={cn(
                                                        "px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap border",
                                                        selectedPlayer === player ? "bg-primary text-slate-900 border-primary shadow-lg" : "bg-white dark:bg-zinc-900 text-slate-400 dark:text-zinc-500 border-slate-200 dark:border-white/5 hover:border-slate-300 dark:hover:border-white/10"
                                                 )}
                                          >
                                                 {player}
                                          </button>
                     ...
                     <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div className="bg-white dark:bg-zinc-900/60 border border-slate-200 dark:border-white/5 rounded-[2rem] p-6 h-fit sticky top-6 shadow-xl">
