              ...
              <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/95 backdrop-blur-2xl">
                     ...
                     <div className="bg-[#09090b] border border-white/10 p-1 md:p-1.5 rounded-[40px] w-full max-w-lg shadow-2xl relative overflow-hidden">
                            <div className="bg-[#09090b] border border-white/5 rounded-[36px] p-8 md:p-12 relative overflow-hidden">
                                   ...
                                   {/* Step indicator dots */}
                                   <div className="flex gap-2 mb-10 relative z-10 justify-center">
                                          {Array.from({ length: TOTAL_STEPS }).map((_, i) => (
                                                 <div
                                                        ...
                                                        className={cn(
                                                               ...
                                                               step >= i + 1
                                                                      ? 'bg-brand-green shadow-[0_0_8px_rgba(16,185,129,0.6)] scale-110'
                                                                      : 'bg-white/10'
                                                        )}
                                                 />
                                          ))}
                                          ...
                                          {step === 1 && (
                                                 ...
                                                 >
                                                        <div className="space-y-4 text-center">
                                                               <div className="inline-flex items-center gap-2 bg-brand-green/10 text-brand-green px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest mx-auto">
                                                                      <Sparkles size={12} /> Bienvenido
                                                               </div>
                                                               <h2 className="text-3xl md:text-4xl font-black text-white tracking-tight">
                                                                      Bienvenido a CourtOps
                                                               </h2>
                                                               <p className="text-zinc-400 text-lg leading-relaxed max-w-md mx-auto">
                                                                      Hola <span className="text-white font-semibold">{clubName}</span>! Configuremos tu club en <span className="text-brand-green font-bold">3 pasos rapidos</span>.
                                                               </p>
                                                        </div>

                                                        <div className="grid grid-cols-3 gap-3">
                                                               {[
                                                                      { icon: LayoutGrid, label: 'Canchas' },
