              ...
              <footer className="py-12 px-6 border-t border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-black text-slate-500 dark:text-zinc-500" id="faq">
                     <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
                            ...
                            <div className="flex flex-col md:flex-row gap-8 text-sm font-medium text-slate-600 dark:text-zinc-400">
                                   <Link href="/legal/terms" className="hover:text-primary dark:hover:text-primary transition-colors">Términos y Condiciones</Link>
                                   <Link href="/legal/privacy" className="hover:text-primary dark:hover:text-primary transition-colors">Política de Privacidad</Link>
                                   <a href="mailto:soporte@courtops.com" className="hover:text-primary dark:hover:text-primary transition-colors">Soporte</a>
                            </div>
