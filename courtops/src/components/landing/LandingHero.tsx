                            ...
                            <div className="flex flex-col items-center gap-6 mt-10">
                                   <div className="flex flex-col sm:flex-row gap-5 justify-center items-center w-full">
                                          ...
                                          >
                                                 ...
                                                 <span className="relative w-full sm:w-auto px-8 py-5 bg-primary text-primary-foreground hover:bg-primary/90 rounded-xl font-bold text-lg transition-transform active:scale-95 flex items-center justify-center gap-3 shadow-lg shadow-primary/25 cursor-pointer">
