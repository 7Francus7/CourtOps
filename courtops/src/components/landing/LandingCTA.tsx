...
export default function LandingCTA() {
       return (
              <section className="py-20 md:py-32 px-4 sm:px-6 bg-white dark:bg-zinc-950 transition-colors duration-700">
                     <div className="max-w-5xl mx-auto">
                            <motion.div
                                   initial={{ opacity: 0, y: 30 }}
                                   whileInView={{ opacity: 1, y: 0 }}
                                   viewport={{ once: true }}
                                   className="relative overflow-hidden rounded-[2.5rem] md:rounded-[3rem] bg-slate-900 dark:bg-zinc-900 p-8 md:p-20 text-center"
                            >
                                   {/* Decorative Elements */}
                                   ...
                                   <div className="relative z-10 space-y-6 md:space-y-8 max-w-3xl mx-auto">
                                          ...
                                          <p className="text-zinc-400 text-base md:text-xl font-medium max-w-xl mx-auto leading-relaxed">
                                                 Digitaliza tu complejo hoy y descubre por qué los mejores clubes eligen CourtOps. 14 días gratis.
                                          </p>

                                          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 px-4 sm:px-0">
                                                 <Link
                                                        href="/register"
                                                        className="w-full sm:w-auto px-8 md:px-10 py-4 md:py-5 rounded-xl md:rounded-2xl bg-white text-black font-bold text-sm shadow-xl hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-2"
                                                 >
                                                        Prueba Gratuita <ArrowRight size={18} />
                                                 </Link>
                                                 <Link
                                                        href="#pricing"
                                                        className="w-full sm:w-auto px-8 md:px-10 py-4 md:py-5 rounded-xl md:rounded-2xl bg-zinc-800 text-white font-bold text-sm border border-white/5 hover:bg-zinc-700 transition-all flex items-center justify-center gap-2"
                                                 >
                                                        Ver Planes
                                                 </Link>
                                          </div>
                                          ...
                                          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 pt-10 md:pt-12 border-t border-white/5 mt-10 md:mt-12">
                                                 {[
                                                        ...
                                                        <div key={i} className="flex items-center justify-center gap-2 text-zinc-500 text-[9px] md:text-[10px] font-bold uppercase tracking-widest">
