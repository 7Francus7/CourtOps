...
export default function LandingHowItWorks() {
       return (
              <section className="py-32 px-6 bg-transparent border-t border-white/[0.06]" id="how-it-works">
                            ...
                            <div className="flex flex-col md:flex-row gap-16 items-center">
                                   <div className="md:w-1/2 space-y-6">
                                          ...
                                          <h3 className="text-3xl sm:text-4xl md:text-6xl font-medium text-slate-900 dark:text-white tracking-tight leading-tight">
                                                 ...
                                                 <span className="text-slate-400 dark:text-zinc-500 font-normal">automatización total.</span>
                                          </h3>
                                   ...
                                   <div className="md:w-1/2 grid grid-cols-1 gap-4">
                                          {steps.map((step, i) => (
                                                 <motion.div
                                                        ...
                                                        className="flex items-start gap-6 p-8 rounded-2xl backdrop-blur-xl bg-white dark:bg-white/[0.04] border border-slate-200 dark:border-white/[0.08] hover:border-slate-300 dark:hover:border-white/15 transition-colors shadow-sm dark:shadow-none"
                                                 >
                                                        <div className="w-12 h-12 rounded-xl bg-slate-100 dark:bg-white/5 flex items-center justify-center shrink-0 border border-slate-200 dark:border-white/10">
                                                               <step.icon className={step.color} size={24} />
                                                        </div>
                                                        <div className="space-y-2">
                                                               <div className="flex items-center gap-3">
                                                                      <span className="text-[10px] font-black text-slate-300 dark:text-zinc-600">0{i + 1}</span>
