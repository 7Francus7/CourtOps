...
export default function LandingPricing() {
       ...
       return (
              <section className="py-24 px-6 bg-slate-50 dark:bg-[#09090b] relative overflow-hidden transition-colors duration-300" id="pricing">
                     ...
                     <div className="absolute bottom-0 left-0 w-[800px] h-[600px] bg-blue-500/5 rounded-full blur-[100px] pointer-events-none mix-blend-multiply dark:mix-blend-normal" />
                                          ...
                                          return (
                                                 <div
                                                        ...
                                                        className={cn(
                                                               ...
                                                               plan.highlight
                                                                      ? "bg-white dark:bg-zinc-900/80 border-emerald-500/50 shadow-2xl shadow-emerald-500/10 dark:shadow-emerald-900/20 z-10 scale-[1.02]"
                                                 ...
                                                 >
                                                        {plan.highlight && (
                                                               <div className="absolute -top-5 left-1/2 -translate-x-1/2 bg-gradient-to-r from-emerald-500 to-cyan-500 text-white dark:text-black font-black text-[10px] uppercase tracking-widest px-4 py-1.5 rounded-full shadow-lg flex items-center gap-2 w-max">
                                                        ...
                                                        <button
                                                               onClick={() => {
                                                                      window.open(`https://wa.me/5493524421497?text=Hola,%20quisiera%20contratar%20el%20plan%20${plan.name}%20(${isYearly ? 'Anual' : 'Mensual'})%20de%20CourtOps`, '_blank')
                                                               }}
                                                               className={cn(
