...
export default function LandingTestimonials() {
  return (
    <section className="py-24 md:py-32 px-4 md:px-6 bg-white dark:bg-[#0b0f19] transition-colors duration-700 relative overflow-hidden">
      {/* Background glow */}
        ...
        >
          {testimonials.map((testimonial, i) => (
            <motion.div
              ...
              className="relative p-8 rounded-2xl bg-slate-50/50 dark:bg-zinc-900/30 border border-slate-200/50 dark:border-white/5 transition-all duration-500 hover:border-emerald-500/30 group overflow-hidden flex flex-col"
            >
              {/* Hover glow */}
              ...
              {/* Author */}
              <div className="relative z-10 flex items-center gap-4 pt-6 border-t border-slate-200/50 dark:border-white/5">
