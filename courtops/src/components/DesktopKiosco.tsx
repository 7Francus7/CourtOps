                                                 ...
                                                 return (
                                                        ...
                                                        >
                                                               <div className="aspect-square bg-black/40 rounded-2xl mb-4 flex items-center justify-center text-4xl group-hover:bg-brand-blue/20 transition-all relative shadow-inner overflow-hidden border border-white/5">
                                                                      ...
                                                                      {p.stock <= 5 && p.stock > 0 && (
                                                                             <span className="absolute top-2 left-2 bg-orange-500/80 text-white text-[7px] font-black px-1.5 py-0.5 rounded-full animate-pulse">STOCK CR├ìTICO</span>
                                                                      )}
                                                               </div>
                                                 ...
                                                 <div className="grid grid-cols-1 gap-5 pt-8 w-full">
                                                        <button
                                                               onClick={() => {
                                                                      ...
                                                                      if (phone) window.open(`https://wa.me/${phone}?text=Hola+${selectedClient?.name},+tu+compra+por+$${total}+en+MarketPadel+fue+registrada.+┬íMuchas+Gracias!`, '_blank')
