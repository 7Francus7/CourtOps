...
import { MessageCircle, AlertTriangle, User, Mail, FileText, UserCheck, Repeat, Clock, DollarSign, CheckCircle2, X, ChevronDown, Sparkles, CalendarDays, MapPin, Search } from 'lucide-react'
