...
export default function FinancialHeader({ date, refreshKey }: { date: Date, refreshKey: number }) {
       ...
       return (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                     ...
                     <div className="bg-card border border-brand-green/20 rounded-xl p-4 flex flex-col relative overflow-hidden group">
                     ...
                     <div className="bg-card border border-yellow-500/20 rounded-xl p-4 flex flex-col relative overflow-hidden group">
                            <div className="absolute top-0 right-0 p-3 opacity-10 group-hover:opacity-20 transition-opacity">
                     ...
                     {/* 3. GASTOS (Expenses) */}
                     <div className="bg-card border border-red-500/20 rounded-xl p-4 flex flex-col relative overflow-hidden group">
                            <div className="absolute top-0 right-0 p-3 opacity-10 group-hover:opacity-20 transition-opacity">
                     ...
                     <div className="bg-card border border-blue-500/20 rounded-xl p-4 flex flex-col relative overflow-hidden bg-gradient-to-br from-blue-500/5 to-transparent">
