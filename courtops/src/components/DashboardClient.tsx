                     ...
                     <div className="hidden md:flex h-full bg-background text-foreground font-sans flex-col w-full overflow-hidden">
                            ...
                            <main className="flex-1 flex flex-col min-h-0 bg-background md:overflow-y-auto lg:overflow-hidden p-3 gap-3">
                                   ...
                                   <div className="flex-1 flex flex-col gap-3 min-h-0">
                                          ...
                                          {/* MAIN CONTENT AREA */}
                                          <div className="flex-1 min-h-0 flex flex-col bg-[#121214]/40 backdrop-blur-xl border border-white/[0.02] rounded-[2rem] overflow-hidden shadow-2xl relative">

                                                 {/* UNIFIED CONTROL BAR (Date & Actions) - Responsive Wrapper */}
                                                 <div className="shrink-0 border-b border-white/[0.02] flex flex-col lg:flex-row lg:items-center justify-between p-4 lg:px-6 lg:h-20 bg-white/[0.01] backdrop-blur-md z-20 relative gap-4 lg:gap-0">
