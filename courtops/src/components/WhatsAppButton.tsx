...
const WSP_NUMBER = '5493524421497'
const WSP_MESSAGE = 'Hola! Me interesa CourtOps para mi club. ¿Me pueden dar más info?'
const WSP_URL = `https://wa.me/${WSP_NUMBER}?text=${encodeURIComponent(WSP_MESSAGE)}`
    ...
    <AnimatePresence>
      {visible ? (
        <motion.div
          ...
          className="fixed bottom-6 right-6 z-[99] flex items-center gap-3"
        >
          {/* Tooltip */}
          <AnimatePresence>
            {tooltip ? (
          ...
          <div className="relative">
            {/* Pulse ring — separate motion element so it doesn't affect layout */}
            <motion.span
