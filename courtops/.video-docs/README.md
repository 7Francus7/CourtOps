...
Step-by-step tutorial videos for **courtops**.
...
```bash
bash scripts/run-all.sh C:\Users\dello\OneDrive\Desktop\SISTEMAS\SISTEMA CANCHA PADEL\courtops\.video-docs/flows/<flow>.json
```

### Re-generate the docs site
```bash
npx tsx scripts/generate-docs-site.ts C:\Users\dello\OneDrive\Desktop\SISTEMAS\SISTEMA CANCHA PADEL\courtops\.video-docs --dev
```

### Record a new section
```bash
# Analyze the app first
npx tsx scripts/analyze-app.ts C:\Users\dello\OneDrive\Desktop\SISTEMAS\SISTEMA CANCHA PADEL\courtops\.video-docs

# Then run the full pipeline for the new flow
bash scripts/run-all.sh C:\Users\dello\OneDrive\Desktop\SISTEMAS\SISTEMA CANCHA PADEL\courtops\.video-docs/flows/<new-flow>.json
```
